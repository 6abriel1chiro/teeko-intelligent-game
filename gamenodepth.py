...
def AlphaBetaPrunning(state, alpha, beta, maximizing_player, available_moves, counter):
    board = state[0]
    player = state[1]
    counter += 1
    ...
    if maximizing_player:
        ...
        for move in available_moves:
            ...
            value, _ ,counter= AlphaBetaPrunning(new_state, alpha,
...
def get_computer_move(state):
    ...
    _, best_move,counter = AlphaBetaPrunning(state, float(
